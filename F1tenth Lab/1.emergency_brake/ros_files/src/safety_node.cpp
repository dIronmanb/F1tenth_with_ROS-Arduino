...
public:
    SubscribeAndPublish() {
        ...
        pub_dc = n_.advertise<std_msgs::Float32>("/dc", 1000);
    ...
    void publish() {
        ...
        if (min_TTC <= TTC_threshold) {
            ...
            std_msgs::Float32 dc_speed;
            dc_speed.data = 0.0;
            pub_dc.publish(dc_speed);
